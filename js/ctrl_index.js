(() => {
    ...
    $signinBtn.addEventListener('click', async e => {
        ...
        // on store dans le localStorage l'utilisateur récupéré dans le cloud firestore
     ...
     * 'lastTimerefreshd' : date à laquelle la page a été raffraichie pour la dernière fois (maintenant),
